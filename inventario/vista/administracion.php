              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-search-plus"></i> Consultar <span class="fa fa-chevron-down"></span></a>
                    ...
                    <ul class="nav child_menu">
                                   <li><a href="#" data-toggle="modal" data-target="#usuarios">Registro</a></li>

                                <li><a href="#con_usuarios" class="info">Consultar</a></li>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <i class="fa fa-user"><span style="margin-left: 5px"><?php echo $_SESSION["admin"]; ?></span></i>
