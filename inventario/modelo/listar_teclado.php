...
while ($row = mysqli_fetch_array($query)) {
            ...
            ?>
                    ...
                    <td class="text-center">
                        <button title="Modificar" type="button" class="btn btn-info btn-xs" data-toggle="modal" data-target="#datosUpdateTeclado" data-ids="<?php echo $row['id'] ?>" data-id="<?php echo $row['id_teclado'] ?>" data-serial="<?php echo $row['serial_teclado'] ?>" data-marca="<?php echo $row['marca_teclado'] ?>" data-placa="<?php echo $row['placa_sena_teclado'] ?>" data-ubicacion="<?php echo $row['ubicacion'] ?>" data-estado="<?php echo $row[6] ?>"><i class='glyphicon glyphicon-edit'></i></button>

                        <?php if (isset($_SESSION["admin"])) {

                ?>

                               <button title="Eliminar" type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#datosDeleteTeclado" data-ids="<?php echo $row['id'] ?>" data-id="<?php echo $row['id_teclado'] ?>" data-serial="<?php echo $row['serial_teclado'] ?>" data-marca="<?php echo $row['marca_teclado'] ?>" data-placa="<?php echo $row['placa_sena_teclado'] ?>" data-ubicacion="<?php echo $row['ubicacion'] ?>" data-estado="<?php echo $row[6] ?>"><i class='glyphicon glyphicon-trash'></i></button>
